                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-striped" id="table1" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    $query =
                                    "SELECT kapasitas.*, COUNT(datappdb_smp_ppalmultazam.nama_gelombang) AS jumlah_pendaftar
                                    FROM kapasitas
                                    LEFT JOIN datappdb_smp_ppalmultazam ON kapasitas.gelombang = datappdb_smp_ppalmultazam.nama_gelombang
