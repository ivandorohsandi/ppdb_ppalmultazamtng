            ...
            <div class="sidebar-wrapper active">
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li class="sidebar-item">
                            <a href="pengaturan_pendaftaran_smp.php" class='sidebar-link'>
                        ...
                        <li class="sidebar-item">
                            <a href="pengaturan_penerimaan.php" class='sidebar-link'>
                        ...
                        <div class="card-body">
                            <table class="table table-striped" id="table1">
                                ...
                                <tbody>
                                    <?php
                                    include '../inc/koneksi.php';
                                    $query = "SELECT * FROM datappdb_smp_ppalmultazam  WHERE status_pendaftaran ='Diterima'";
                                    $result = $koneksi->query($query);
