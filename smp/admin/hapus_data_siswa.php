...
if (isset($_GET['nomor_pendaftaran'])) {
    ...
    $queryGetFiles = "SELECT foto, skl FROM datappdb_smp_ppalmultazam WHERE nomor_pendaftaran = '$nomor_pendaftaran'";
    ...
    if ($resultGetFiles->num_rows == 1) {
        ...
        $queryDeleteSiswa = "DELETE FROM datappdb_smp_ppalmultazam WHERE nomor_pendaftaran = '$nomor_pendaftaran'";
