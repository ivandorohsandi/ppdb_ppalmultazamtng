                ...
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-6 order-md-1 order-last">
                            <h3>Data siswa yang sudah mendaftar</h3>
                        </div>
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
                                    <li class="breadcrumb-item"><a href="data_siswa.php">SMA</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Semua Pendaftar</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="badges ">
                                ...
                                $query = "SELECT COUNT(*) as jumlah_siswa FROM datappdb_sma_ppalmultazam";
                                ...
                                ?>
                                <?php
                                $query2 = "SELECT COUNT(*) as status_pendaftaran FROM datappdb_sma_ppalmultazam WHERE status_pendaftaran = 'Belum Diverifikasi'";
                                ...
                                ?>
                                <?php
                                $query3 = "SELECT COUNT(*) as status_pendaftaran FROM datappdb_sma_ppalmultazam WHERE status_pendaftaran = 'Diterima'";
                                ...
                                ?>
                                <?php
                                $query4 = "SELECT COUNT(*) as status_pendaftaran FROM datappdb_sma_ppalmultazam WHERE status_pendaftaran = 'Tidak Diterima'";
                        ...
                        <div class="card-body">
                            <button type="button" class="btn icon icon-left btn-danger block" data-bs-toggle="modal" data-bs-target="#exampleModalCenter"><i class="bi bi-file-earmark-pdf-fill"></i>
                                PDF
                            </button>
                            <div class="modal fade" id="exampleModalCenter" tabindex="-1" aria-labelledby="exampleModalCenterTitle" style="display: none;" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered modal-dialog-centered modal-dialog-scrollable" role="document">
                                    <form action="export_pdf_all.php" method="GET" class="col-12">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <label for="status">Pilih Status Pendaftaran</label>
                            ...
                            <button type="button" class="btn icon icon-left btn-success block" data-bs-toggle="modal" data-bs-target="#exampleModalCenter2"><i class="bi bi-file-earmark-excel-fill"></i>
                                Excel
                            </button>
                            <div class="modal fade" id="exampleModalCenter2" tabindex="-1" aria-labelledby="exampleModalCenterTitle" style="display: none;" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered modal-dialog-centered modal-dialog-scrollable" role="document">
                                    <form action="export_excel.php" method="GET" class="col-12">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalCenterTitle">
                                                    Export Data
                            ...
                            <table class="table table-striped" id="table1" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    if ($result->num_rows > 0) {
                                        while ($row = $result->fetch_assoc()) {
                                            $id_daftar_sma          = $row['id_daftar_sma'];
                                            ...
                                            echo "<tr>
                                                    ...
                                                    <td>    
                                                        <a href='edit_data_siswa.php?nomor_pendaftaran=$nomor_pendaftaran'  class='btn btn-sm btn-primary mb-1'>Edit</a>
                                                        <button data-id='$nomor_pendaftaran' class='btn btn-sm btn-danger mb-1' onclick='confirmDelete(this)'>Hapus</button>
                                ...
                                <script>
                                    function confirmDelete(button) {
                                        var nomorPendaftaran = button.getAttribute('data-id');
                                        ...
                                        Swal.fire({
                                            ...
                                            if (result.isConfirmed) {
                                                ...
                                                window.location.href = 'hapus_data_siswa.php?nomor_pendaftaran=' + nomorPendaftaran;
                                            }
                                        });
                                    }
                                    ...
                                    if (pesanKonfirmasi !== "") {
                                        ...
                                        history.replaceState({}, document.title, 'data_siswa.php');
                                    }
                                </script>
                            </table>
                        </div>
