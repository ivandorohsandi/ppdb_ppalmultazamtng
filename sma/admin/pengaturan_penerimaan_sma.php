                ...
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-6 order-md-1 order-last">
                            <h3>Anda dapat mengatur penerimaan disini</h3>
                        </div>
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Pengaturan Penerimaan</a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <section class="section">
                    <div class="card">
                        <div class="card-body">
                            ...
                            $query = "SELECT * FROM setting_penerimaan";
                            ...
                            <div class="col-md-12 col-12 mb-3">
                                ...
                                <input type="text" id="first-name-column" class="form-control" name="status_penerimaan" value="<?php echo $status_penerimaan; ?>" disabled>
                                </div>
                            </div>
                            ...
                            <form action="" method="POST">
                                <div class="col-md-12 col-12">
                                    <div class="form-group ">
                                        <select class="form-select" aria-label="Default select example" name="status_penerimaan">
                                ...
                                if (isset($_POST['update'])) {
                                    ...
                                    $query_penerimaan = "UPDATE setting_penerimaan SET status_penerimaan = '$status_penerimaan'";
                                    if ($koneksi->query($query_penerimaan)) {
                                        echo "
                                        <script>
                                            Swal.fire({
                                                    title: 'Berhasil',
                                                    ...
                                                    window.location.href = '../admin/pengaturan_penerimaan_sma.php';
                                            });
                                        </script>";
                                    } else {
                                        echo "
