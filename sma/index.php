...
<head>
    ...
    <title>PPDB SMA | Pondok Pesantren Al-Multazam Sepatan Tangerang</title>
...
<body>
    ...
    <div class="container-md mt-5" style="background-color: #e9ecef; padding:30px; border-radius:5px;">
        <div class="jumbotron">
            <h1 class="display-5 fs-4 text-uppercase fw-bold">ppdb sma pondok pesantren al-multazam</h1>
