...
<body>
    ...
    $query = "SELECT tgl_daftar, COUNT(*) as jumlah_pendaftar FROM datappdb_smk_ppalmultazam GROUP BY tgl_daftar"; // Gantilah 'data_profile_visit' dengan nama tabel Anda
