...
if ($result && $result->num_rows == 1) {
    ...
    class MYPDF extends TCPDF {
        ...
        public function Header() {
            if ($this->isFirstPage) {
                ...
                $this->MultiCell(0, 0, 'Kab. Tangerang Prov. Banten 15520 Email : ponpesalmultazamtng@gmail.com', 0, 'C');
    ...
    // Masukkan data siswa ke dalam PDF
    // Tambahkan teks "Formulir Penerimaan Peserta Didik Baru Tahun 2023"


    // Tambahkan nomor urut setiap kali Anda menghasilkan formulir PDF
    // Anda dapat menambahkan ini pada bagian yang menghasilkan formulir PDF
    ...
    $pdf->SetFont('helvetica', '', 12);
    $pdf->Cell(55, 10, 'Jurusan Yang Diminati', 0);
    $pdf->Cell(10, 10, ':', 0);
    $pdf->Cell(50, 10, $row['jurusan'], 0);
    $pdf->Ln();
