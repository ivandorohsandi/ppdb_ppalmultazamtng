                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="badges ">
                                ...
                                $query = "SELECT COUNT(*) as jumlah_siswa FROM datappdb_smk_ppalmultazam";
                                ...
                                ?>
                                <?php
                                $query2 = "SELECT COUNT(*) as status_pendaftaran FROM datappdb_smk_ppalmultazam WHERE status_pendaftaran = 'Belum Diverifikasi'";
                                ...
                                ?>
                                <?php
                                $query3 = "SELECT COUNT(*) as status_pendaftaran FROM datappdb_smk_ppalmultazam WHERE status_pendaftaran = 'Diterima'";
                                ...
                                ?>
                                <?php
                                $query4 = "SELECT COUNT(*) as status_pendaftaran FROM datappdb_smk_ppalmultazam WHERE status_pendaftaran = 'Tidak Diterima'";
                                ...
                                <tbody>
                                    ...
                                    if ($result->num_rows > 0) {
                                        while ($row = $result->fetch_assoc()) {
                                            $id_daftar_smk          = $row['id_daftar_smk'];
