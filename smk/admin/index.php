                                    ...
                                    <div class="card-body px-4 py-4-5">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                                ...
                                                $query = "SELECT COUNT(*) as status_pendaftaran FROM datappdb_smk_ppalmultazam";
                                    ...
                                    <div class="card-body px-4 py-4-5">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                                ...
                                                <?php
                                                include '../inc/koneksi.php';
                                                $query = "SELECT COUNT(*) as status_pendaftaran FROM datappdb_smk_ppalmultazam WHERE status_pendaftaran = 'Diterima'";
                                                $result = $koneksi->query($query);
                                                if ($result->num_rows > 0) {
                                                    // Mengambil hasil perhitungan
                                                    $row = $result->fetch_assoc();
                                    ...
                                    <div class="card-body px-4 py-4-5">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                                ...
                                                <?php
                                                include '../inc/koneksi.php';
                                                $query = "SELECT COUNT(*) as status_pendaftaran FROM datappdb_smk_ppalmultazam WHERE status_pendaftaran = 'Tidak diterima'";
                                                $result = $koneksi->query($query);
                                                if ($result->num_rows > 0) {
                                                    // Mengambil hasil perhitungan
                                                    $row = $result->fetch_assoc();
